...
-(instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame])
    {
        ...
        self.color_btnBG_prominent = XB_Color_white;
        self.color_btnTitle_prominent = XBColor_blue_35_149_255;
        self.color_btnBG_nor = XB_Color_white;
        self.color_btnTitle_nor = XBColor_gray_136_136_136;
        self.color_partingLine = XBColor_gray_230_230_230;
        self.backgroundViewColor = [XBColor_black colorWithAlphaComponent:0.5];
    }
    return self;
}
...
- (UIButton *)createButtonWithTag:(NSInteger)tag
{
    ...
    button.titleLabel.font = XB_Font(15);
...
//    [button setBackgroundImage:[self createImageWithColor:[[self getBtnBgColorWithTag:tag] colorWithAlphaComponent:0.6]] forState:UIControlStateHighlighted];
    [button setBackgroundImage:[self createImageWithColor:[XBColor_gray_136_136_136 colorWithAlphaComponent:0.6]] forState:UIControlStateHighlighted];
...
{
    return self.str_message.length ? 12.5 : 25;
}

- (CGFloat)getSpaceOfTitleAndMsg
{
    return self.str_title.length ? 17.5 : 12.5;
}
...
- (UILabel *)lb_title
{
    if (_lb_title == nil)
    {
        ...
        label.font = XB_Font_bold(15);
        label.numberOfLines = 0;
        label.text = self.str_title;
        
        [label mas_remakeConstraints:^(MASConstraintMaker *make) {
            make.top.equalTo(self).offset([self getSpaceOfTopAndTitle]);
